 ...
 * @version $Revision$
 */
public class MemoryLoaderMutableAnnotationsInvalidationUnitTestCase extends MutableMetaDataLoaderAnnotationsInvalidationTest
{
   public MemoryLoaderMutableAnnotationsInvalidationUnitTestCase(String name)
   {
      super(name);
   }
