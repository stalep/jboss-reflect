 ...
 * @version $Revision$
 */
public class MemoryLoaderMutableMetaDataInvalidationUnitTestCase extends MutableMetaDataLoaderMetaDataInvalidationTest
{
   public MemoryLoaderMutableMetaDataInvalidationUnitTestCase(String name)
   {
      super(name);
   }
