...
public class MetaDataLoaderTestSuite extends TestSuite
{
   ...
   {
      TestSuite suite = new TestSuite("MetaDataLoader Tests");

      suite.addTest(MemoryMetaDataLoaderTestSuite.suite());
      suite.addTest(ThreadLocalMetaDataLoaderTestSuite.suite());
      suite.addTest(ReflectionMetaDataLoaderTestSuite.suite());
