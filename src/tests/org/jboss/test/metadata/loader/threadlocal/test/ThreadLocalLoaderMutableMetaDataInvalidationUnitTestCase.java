...
/**
 * ThreadLocalLoaderMutableMetaDataInvalidationUnitTestCase.
 * 
 * @author <a href="adrian@jboss.com">Adrian Brock</a>
 * @version $Revision$
 */
public class ThreadLocalLoaderMutableMetaDataInvalidationUnitTestCase extends MutableMetaDataLoaderMetaDataInvalidationTest
{
   ThreadLocalMetaDataLoader loader = ThreadLocalMetaDataLoader.INSTANCE;

   public ThreadLocalLoaderMutableMetaDataInvalidationUnitTestCase(String name)
   {
      super(name);
   }
