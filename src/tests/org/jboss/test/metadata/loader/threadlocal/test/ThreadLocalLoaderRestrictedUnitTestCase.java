...
/**
 * ThreadLocalLoaderRestrictedUnitTestCase.
 * 
 * @author <a href="adrian@jboss.com">Adrian Brock</a>
 * @version $Revision$
 */
public class ThreadLocalLoaderRestrictedUnitTestCase extends MutableRestrictedTest
{
   ThreadLocalMetaDataLoader loader = ThreadLocalMetaDataLoader.INSTANCE;

   public ThreadLocalLoaderRestrictedUnitTestCase(String name)
   {
      super(name);
   }
