...
/**
 * BasicContextBasicMetaDataUnitTestCase.
 * 
 * @author <a href="adrian@jboss.com">Adrian Brock</a>
 * @version $Revision$
 */
public class BasicContextBasicMetaDataUnitTestCase extends BasicMetaDataTest
{
   public BasicContextBasicMetaDataUnitTestCase(String name)
   {
      super(name);
   }
