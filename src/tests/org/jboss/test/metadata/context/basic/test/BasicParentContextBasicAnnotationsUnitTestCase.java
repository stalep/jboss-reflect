 ...
 * @version $Revision$
 */
public class BasicParentContextBasicAnnotationsUnitTestCase extends BasicAnnotationsTest
{
   public BasicParentContextBasicAnnotationsUnitTestCase(String name)
   {
      super(name, false);
   }
